...
class AdminCustomerController extends Controller
{
    ...
    public function index()
    {
     ...
     // dd($customerlist);
        ...
        return view('Admin.Customers.index',compact('customerdata'));
    }
    ...
    public function create()
    {
        ...
        return view('Admin.Customers.create',compact('custdata'));
    }
    ...
    public function store(Request $request)
    {
        ...
        request()->validate(
           ...
           try {
            ...
            return redirect('/admin/customers/index')->with('success');
    ...
    public function edit($id)
    {
        ...
        return view('Admin.Customers.edit',compact('custdata'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/customers/index')->with('success','Deletion Successful');
    }
}
