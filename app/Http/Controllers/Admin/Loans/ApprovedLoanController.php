...
class ApprovedLoanController extends Controller
{
    ...
    {
        //
        $loans = LoanApplication::where('loan_status', 0)->get();
        //dd( $loans);
        ...
        return view("Admin.Loans.ApprovedLoans.index", compact('loans'));
    }
    ...
    public function show($id)
    {
        ...
        return view("Admin.Loans.ApprovedLoans.show", compact('appliedLoan'));
    }
    ...
    public function edit($id)
    {
        ...
        $loandata['loan'] = $loan;
        return view("Admin.Loans.ApprovedLoans.edit", compact('$loandata'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/loans/approvedloans/index/'. $loan_id)->with('success', 'Deletion Successfull');
    }
}
