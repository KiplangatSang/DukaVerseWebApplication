																				...
																				<form class="form-horizontal" method="POST" enctype="multipart/form-data"
																								...
																								<div class="form-group col">
																												...
																												<input class="form-control  @error('emp_name') is-invalid @enderror" type="text"
																																placeholder="Enter Employee's Name" name="emp_name" value="{{ old('emp_name') }}"
																															 required>
																								...
																								<div class="form-group col">
																												<div class="form-group">
																																...
																																<input class="form-control  @error('emp_role') is-invalid @enderror" type="text"
																																				placeholder="Enter employee's role" name="emp_role" value="{{ old('emp_role')}}"
																																				autocomplete="emp_role" required>
																																@error('emp_role')
																																				<span class="invalid-feedback" role="alert">
																																								<strong>{{ $message }}</strong>
																																				</span>
																								...
																								<div class="form-group col">
																												...
																												<div>
																																<input class="form-control  @error('emp_ID') is-invalid @enderror" type="text"
																																				...
																																				value="{{ old('emp_ID') }}" autocomplete="emp_ID" required>
																								...
																								<div class="form-group col">
																												...
																												<div>
																																<input class="form-control  @error('emp_phoneno') is-invalid @enderror" type="phone"
																																				...
																																				value="{{ old('emp_phoneno') }}" autocomplete="emp_phoneno" required>
																				...
																				<div class="row">
																								<div class="col-md-8 col-md-offset-3 mx-auto">
																												<button class="btn btn-primary" type="submit"><i
																																...
																																Employee</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="/client/employee/index"><i
