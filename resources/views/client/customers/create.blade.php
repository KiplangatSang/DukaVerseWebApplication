				...
				<div class="row">
								<div class="col">
												<div class="tile">
																...
																<div class="tile-body">
																				<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/client/customers/store">
																...
																<div class="form-group col">
																				...
																				<input class="form-control  @error('emp_name') is-invalid @enderror" type="text"
																								placeholder="Enter Customer Name" name="name" value="{{ old('name') }}" autocomplete="name"
																								required>
