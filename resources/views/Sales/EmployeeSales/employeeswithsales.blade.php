    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small primary coloured-icon"><i class="icon fa fa-sales fa-3x"></i>
        <div class="info">
          ...
          <p class="text-warning"><b>{{{$empdata['salesdata']['salesitems']}}}</b></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
      <div class="widget-small info coloured-icon"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
        <div class="info">
          <h4>Total Revenue</h4>
          <p class="text-warning"><b>{{{$empdata['salesdata']['salesrevenue']}}} ksh</b></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
        <div class="info">
          <h4>Sales Per Day</h4>
          <p class="text-warning"><b>{{{$empdata['salesdata']['salesrevenue']}}}</b></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
          ...
          <div class="table-responsive">
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                  ...
                  @foreach ($empdata['salesdata'] as $saleitem)
