																				...
																				<div class="tile-body">
																								...
																								<div class="form-group col">
                                                                                                    <div class="col col-sm-6">
                                                                                                        ...
                                                                                                        <div>
                                                                                                                        <input class="form-control  @error('billAmount') is-invalid @enderror"
                                                                                                                                        type="text" placeholder="Enter  amount to be paid" name="billAmount"
																								...
																								<div class="form-group col">
																												...
																												<div>
																																<textarea class="form-control  @error('billDescription') is-invalid @enderror"
																																				...
																																				value="{{ old('billDescription') }}" autocomplete="billDescription"
																																				required></textarea>
