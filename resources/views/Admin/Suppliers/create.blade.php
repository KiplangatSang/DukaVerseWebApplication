												...
												<div class="tile">
																...
																<div class="tile-body">
																				<form class="form-horizontal" method="POST" enctype="multipart/form-data"
																								action="/supplies/suppliers/store">
																...
																<div class="form-group col">
																				...
																				<input class="form-control  @error('name') is-invalid @enderror" type="text"
																								placeholder="Enter Supplier Name" name="name" value="{{ old('name') }}" autocomplete="name"
																								required>
																...
																<div class="form-group col">
																				...
																				<div>
																								<input class="form-control  @error('id_number') is-invalid @enderror" type="text"
																												...
																												value="{{ old('id_number') }}" autocomplete="id_number" required>
																...
																<div class="form-group col">
																				...
																				<div>
																								<input class="form-control  @error('phone_number') is-invalid @enderror" type="phone"
																												...
																												value="{{ old('phone_number') }}" autocomplete="phone_number" required>
																...
																<div class="form-group col">
																				...
																				<div>
																								<input class="form-control  @error('email') is-invalid @enderror" type="email"
																												placeholder="Enter Supplier Email" name="email" value="{{ old('email') }}"
																				...
																				<div class="row">
																								<div class="col-md-8 col-md-offset-3">
																												<button class="btn btn-primary" type="submit"><i
																																...
																																Supplier</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="/supplies/suppliers/index"><i
