				...
				<div class="row justify-content-center">
								...
								<div class="col">
												...
												<script>
												    ...
												    var name = "Hi there !!";
												    var message =
												        "            Thanks for checking us out. From now on we will be at your service  we are committed to providing the best experience to our customers" +
																				...
																				<div class="card-body bg-white">
																								<form method="POST" action="{{ route('login') }}">
																												...
																												<div class="form-group row justify-content-center">
																																<label for="loginheader"
																																				class="col-md-4 col-form-label text-md-centre">{{ __('Login') }}</label>
																												</div>
