...
<body  class="app sidebar-mini" >
      ...
      <aside class="app-sidebar bg-success">
        ...
        <ul class="app-menu ">
          <li><a class="app-menu__item active bg-success" href="/home"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
          <li class="treeview"><a class="app-menu__item  bg-success" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Sales</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu  bg-success">
              ...
              <li ><a class="treeview-item   bg-success" href="/createsales"><i class="icon fa fa-circle-o "></i>Add item sold</a></li>
            </ul>
          </li>
          ...
          <li class="treeview"><a class="app-menu__item  bg-success" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Required Items</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu  bg-success">
              <li><a class="treeview-item   bg-success" href="/show-all-required-item"><i class="icon fa fa-circle-o"></i>All Required Items</a></li>
              ...
              <li ><a class="treeview-item   bg-success" href="/create-requireditems"><i class="icon fa fa-circle-o "></i> Add Required Items</a></li>
            </ul>
          </li>
          ...
          <li class="treeview"><a class="app-menu__item  bg-success" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Loans</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item  bg-success" href="/get-available-loans"><i class="icon fa fa-circle-o"></i>Request A Loan</a></li>
              <li><a class="treeview-item  bg-success" href="#"><i class="icon fa fa-circle-o"></i>Pay A loan</a></li>            </ul>
          </li>
