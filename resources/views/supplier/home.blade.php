...
@section('content')
				...
				<div class="row d-flex justify-content-center">
								<div class="col-md-6 col-lg-3 tile m-1">
												<div class="widget-small primary coloured-icon"><i class="icon fa fa-etsy fa-3x"></i>
																<div class="info">
																				<h4>Account</h4>
																				<p><b>{{ auth()->user()->account()->first()->account ?? 'No account' }}</b></p>
																</div>
												</div>
								</div>
								<div class="col-md-6 col-lg-3 tile m-1">
												...
												<div class="widget-small primary coloured-icon"><i class="icon fa fa-etsy fa-3x"></i>
																<div class="info">
																				<h4>Balance</h4>
																				<p><b>{{ auth()->user()->account()->first()->balance ??'N/A' }} </b></p>
																</div>
												</div>
								</div>
								<div class="col-md-6 col-lg-3 tile m-1">
												...
												<div class="widget-small primary coloured-icon"><i class="icon fa fa-etsy fa-3x"></i>
																<div class="info">
																				<h4>On Hold</h4>
																				<p><b>{{ auth()->user()->account()->first()->on_hold ??'N/A' }}</b></p>
																</div>
												</div>
								</div>
				</div>
				...
				<div class="row">
								<div class="container">
												<div class="col-md-10 col-xl-10 mx-auto">
																<div class="tile m-2 ">
																				<h3 class="tile-title ">Deliveries {{ date('Y') }}</h3>
								...
								<div class="col-md-6">
												<div class="tile">
																<h3 class="tile-title">Orders {{ date('M') . ' ' . date('Y') }}</h3>
